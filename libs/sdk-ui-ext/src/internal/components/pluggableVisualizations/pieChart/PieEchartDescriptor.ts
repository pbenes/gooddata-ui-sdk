...
import { PluggablePieEchart } from "./PluggablePieEchart";
...
export class PieEchartDescriptor extends BaseChartDescriptor implements IVisualizationDescriptor {
    public getFactory(): PluggableVisualizationFactory {
        return (params) => new PluggablePieEchart(params);
    }
